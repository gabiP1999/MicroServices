...
public interface MessageBus {
     ...
     */
    //@PRE isCompleted(e) = false
    //@POST isCompleted(e) = true
    <T> void complete(Event<T> e, T result);
    <T> boolean isCompleted(Event<T> e);
     ...
     */
    //@PRE wasBroadcastSent(b) = false
    //@POST wasBroadcastSent(b) = true
    void sendBroadcast(Broadcast b);
    boolean wasBroadcastSent(Broadcast b);
     ...
     */
    //@PRE wasEventSent(e) = false
    //@POST wasEventSent(e) = true
      <T> Future<T> sendEvent(Event<T> e);
      <T> boolean wasEventSent(Event<T> e);
     ...
     * {@link #register(mics.MicroService)} and cleans all references
