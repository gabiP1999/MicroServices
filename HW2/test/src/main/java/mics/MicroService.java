...
public abstract class MicroService implements Runnable {
    ...
    private Map<String,Callback> MessageCallbacks;
    ...
    public MicroService(String name) {
        this.name = name;
        bus=MessageBusSingleton.getInstance();
    ...
    public final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
       ...
       MessageCallbacks.put(type.getName(), callback);
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                //System.out.println(this.name+"  Attempting Message callback");
                MessageCallbacks.get(m.getClass().getName()).call(m);
                //System.out.println(this.name+" Message callback succeed");
